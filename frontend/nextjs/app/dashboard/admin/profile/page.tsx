    ...
    <DashboardLayout role="admin">
      <div className="space-y-6 max-w-3xl mx-auto">
        <nav className="mb-2 flex items-center gap-2 text-sm text-muted-foreground">
          <Link href="/dashboard/admin" className="transition hover:text-foreground">Accueil</Link>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center gap-5">
                <div className="relative">
                  <Avatar className="h-20 w-20 ring-2 ring-primary/10">
                    ...
                    <AvatarFallback>
                      {profile ? `${profile.firstName[0]}${profile.lastName[0]}` : user ? `${user.firstName[0]}${user.lastName[0]}` : "AD"}
                    </AvatarFallback>
                  </Avatar>
                ...
                <div>
                  <h3 className="font-semibold text-foreground">
                    {profile ? `${profile.firstName} ${profile.lastName}` : user ? `${user.firstName} ${user.lastName}` : "Admin"}
                  </h3>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center rounded-md bg-muted/20 px-3 py-2 min-h-9">
                    <p className="text-sm text-foreground">Administrateur</p>
                  </div>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs text-muted-foreground font-bold flex items-center gap-1.5">
                  ...
                  <div className="flex items-center rounded-md bg-muted/20 px-3 py-2 min-h-9">
                    <p className="text-sm text-foreground">
                      {profile?.joinedAt ? format(new Date(profile.joinedAt), "dd MMMM yyyy") : "Non disponible"}
                    </p>
                  </div>
                </div>
              </div>
